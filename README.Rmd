...
The last version of the dataset was updated on `r formatted_date` and contains information on `r nrow(last_version)` **outbreaks**, associated with `r num_diseases` infectious diseases that occurred from 01/1996 to `r formatted_month` in `r num_countries` countries and territories worldwide.
